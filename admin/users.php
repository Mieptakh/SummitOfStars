...
if(isset($_POST['action'])){
    ...
    $role = 'admin'; // sesuai constraint tabel

    if($_POST['action']=='add'){
        $hash = password_hash($password, PASSWORD_DEFAULT);
        $stmt = $conn->prepare("INSERT INTO users (username, password, role) VALUES (?, ?, ?)");
        $stmt->execute([$username, $hash, $role]);
        $_SESSION['message'] = "User admin berhasil ditambahkan!";
        ...
        $_SESSION['message'] = "User admin berhasil diperbarui!";
    } elseif($_POST['action']=='delete'){
        $id = $_POST['id'];
        $stmt = $conn->prepare("DELETE FROM users WHERE id=?");
        $stmt->execute([$id]);
        $_SESSION['message'] = "User admin berhasil dihapus!";
    }
    header("Location: users.php"); exit;
}

// Fetch all users
$users = $conn->query("SELECT id, username, role, created_at FROM users ORDER BY id DESC")->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <div class="main-content">
        <div class="header">
            <div class="welcome-text">
                <h1>Kelola Users Admin</h1>
                <p>Tambahkan, edit, atau hapus akun admin</p>
            </div>
            <div class="user-info">
        ...
        <div class="page-content">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title"><i class="fas fa-edit"></i> Edit User Admin</h5>
            ...
            <div class="text-center p-4">
                ...
                <h4 class="text-muted">Belum ada user admin</h4>
                <p>Tambahkan user pertama dengan tombol "Tambah Admin"</p>
            </div>
            <?php endif; ?>
        </div>
...
<div class="modal fade" id="addModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fas fa-plus"></i> Tambah Admin</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <form method="post">
                <div class="modal-body">
