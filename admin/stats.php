<?php
session_start();
include "../config.php"; // pastikan $conn (PDO) tersedia
...
if(isset($_POST['action'])){
    ...
    if($_POST['action']=='add'){
        $stmt = $conn->prepare("INSERT INTO stats (label, value) VALUES (?, ?)");
        $stmt->execute([$label, $value]);
        $_SESSION['message'] = "Statistik berhasil ditambahkan!";
    } elseif($_POST['action']=='edit'){
        $id = $_POST['id'];
        $stmt = $conn->prepare("UPDATE stats SET label=?, value=? WHERE id=?");
        $stmt->execute([$label, $value, $id]);
        $_SESSION['message'] = "Statistik berhasil diperbarui!";
    } elseif($_POST['action']=='delete'){
        $id = $_POST['id'];
        $stmt = $conn->prepare("DELETE FROM stats WHERE id=?");
        $stmt->execute([$id]);
        $_SESSION['message'] = "Statistik berhasil dihapus!";
    }
    header("Location: stats.php"); exit;
}

// Fetch all stats
$stats = $conn->query("SELECT * FROM stats ORDER BY id DESC")->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li><a href="stats.php" class="active"><i class="fas fa-chart-bar"></i> Statistik</a></li>
            </ul>
        </div>
    ...
    <div class="main-content">
        <div class="header">
            <div class="welcome-text">
                ...
                <p>Tambahkan, edit, atau hapus data statistik</p>
            </div>
            <div class="user-info">
        ...
        <div class="page-content">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-1">
                                ...
                                <form method="post" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus statistik ini?');">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title"><i class="fas fa-edit"></i> Edit Statistik</h5>
                                ...
                                <form method="post">
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            <label>Nilai</label>
                                            <input type="number" name="value" class="form-control" value="<?= htmlspecialchars($s['value']) ?>" required>
                                        </div>
                                    </div>
            ...
            <div class="text-center p-4">
                ...
                <p>Tambahkan data statistik pertama dengan tombol "Tambah Statistik Baru"</p>
            </div>
            <?php endif; ?>
        </div>
...
<div class="modal fade" id="addModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fas fa-plus"></i> Tambah Statistik Baru</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <form method="post">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label>Label</label>
                        <input type="text" name="label" class="form-control" placeholder="Masukkan label statistik" required>
                    </div>
                    <div class="mb-3">
                        <label>Nilai</label>
                        <input type="number" name="value" class="form-control" placeholder="Masukkan nilai statistik" required>
                    </div>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
