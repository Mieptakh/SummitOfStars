<?php
session_start();
include "../config.php"; // pastikan ini berisi koneksi $conn (PDO)
...
if(isset($_POST['action'])){
    ...
    if($_POST['action']=='add'){
        ...
        $_SESSION['message'] = "FAQ berhasil diperbarui!";
...
// Fetch all FAQ
$faqs = $conn->query("SELECT * FROM faq ORDER BY id DESC")->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <div class="main-content">
        <div class="header">
            <div class="welcome-text">
                <h1>Kelola FAQ</h1>
                <p>Tambahkan, edit, atau hapus pertanyaan dan jawaban FAQ di website.</p>
            </div>
            <div class="user-info">
        ...
        <div class="page-content">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-1">
                                <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editModal<?= $f['id'] ?>">
                                    <i class="fas fa-edit"></i> Edit
                                </button>
                                <form method="post" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus FAQ ini?');">
                                ...
                                <form method="post">
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="question" class="form-control" value="<?= htmlspecialchars($f['question']) ?>" required>
                                        </div>
                                        <div class="mb-3">
                                            <label>Jawaban</label>
            ...
            <div class="text-center p-4">
                ...
                <p>Tambahkan FAQ pertama dengan tombol "Tambah FAQ Baru"</p>
            </div>
            <?php endif; ?>
        </div>
...
<div class="modal fade" id="addModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fas fa-plus"></i> Tambah FAQ Baru</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <form method="post">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label>Jawaban</label>
                        <textarea name="answer" class="form-control" rows="4" placeholder="Masukkan jawaban" required></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
