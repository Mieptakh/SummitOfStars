...
if(isset($_POST['action'])){
    ...
    if(isset($_FILES['image']) && $_FILES['image']['tmp_name']){
        ...
        $image_path = substr($image_path,3); // hapus "../" untuk path frontend
    }

    if($_POST['action']=='add'){
        $stmt = $conn->prepare("INSERT INTO galeri (title, image_url) VALUES (?, ?)");
        $stmt->execute([$title, $image_path]);
        $_SESSION['message'] = "Galeri berhasil ditambahkan!";
    } elseif($_POST['action']=='edit'){
        $id = $_POST['id'];
        $stmt = $conn->prepare("UPDATE galeri SET title=?, image_url=? WHERE id=?");
        $stmt->execute([$title, $image_path, $id]);
        $_SESSION['message'] = "Galeri berhasil diperbarui!";
...
$galeri = $conn->query("SELECT * FROM galeri ORDER BY id DESC")->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li><a href="galeri.php" class="active"><i class="fas fa-image"></i> Galeri</a></li>
            </ul>
        </div>
    ...
    <div class="main-content">
        <div class="header">
            <div class="welcome-text">
                <h1>Kelola Galeri</h1>
                <p>Tambahkan, edit, atau hapus item galeri</p>
            </div>
            <div class="user-info">
        ...
        <div class="page-content">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="<?= $g['image_url'] ?>" width="100" alt="<?= htmlspecialchars($g['title']) ?>"></td>
                        <td>
                            <div class="d-flex gap-1">
                                <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editModal<?= $g['id'] ?>">
                                    <i class="fas fa-edit"></i> Edit
                                </button>
                                <form method="post" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus galeri ini?');">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title"><i class="fas fa-edit"></i> Edit Galeri</h5>
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    <div class="modal-body">
                                        ...
                                        <input type="hidden" name="id" value="<?= $g['id'] ?>">
                                        <input type="hidden" name="old_image" value="<?= $g['image_url'] ?>">
                                        <div class="mb-3">
                                            <label>Judul</label>
            ...
            <div class="text-center p-4">
                ...
                <h4 class="text-muted">Belum ada item galeri</h4>
                <p>Tambahkan item pertama dengan tombol "Tambah Galeri Baru"</p>
            </div>
            <?php endif; ?>
        </div>
...
<div class="modal fade" id="addModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fas fa-plus"></i> Tambah Galeri Baru</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <form method="post" enctype="multipart/form-data">
                <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                    <button class="btn btn-primary">Simpan Galeri</button>
                </div>
            </form>
        </div>
    </div>
